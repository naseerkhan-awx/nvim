...
-- Use native key remaps instead of :normal, because <C-i> is a tab and can't be passed to :normal.
vim.keymap.set("n", "<D-[>", "<C-o>", { desc = "Jump Back" })
vim.keymap.set("n", "<D-]>", "<C-i>", { desc = "Jump Forward" })
vim.keymap.set("i", "<D-[>", "<C-o><C-o>", { desc = "Jump Back" })
vim.keymap.set("i", "<D-]>", "<C-o><C-i>", { desc = "Jump Forward" })
vim.keymap.set("v", "<D-[>", "<Esc><C-o>", { desc = "Jump Back" })
vim.keymap.set("v", "<D-]>", "<Esc><C-i>", { desc = "Jump Forward" })
